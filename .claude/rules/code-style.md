...
The numbered rules `R0` to `R32` are workspace-wide and stable; cite them by number in a
...
`R28` in `preferences.md`, `R18`, `R26`, `R29`, `R30`, `R31` and `R32` in `workflows.md`, `R20` and
