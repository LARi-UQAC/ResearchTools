...
---
<!--
HAND-MAINTAINED. Unlike every other file in this directory, this one is NOT generated by
install.ps1 and has no source file under .claude/rules/. It stays here because it is
specific to GitHub Copilot inside VS Code (extension LM tools, VS Code command IDs,
@mermaid-chart slash commands); a rule under .claude/rules/ is mirrored to OpenCode,
Continue and Aider as well, where those command IDs mean nothing. Edit this file directly;
running install.ps1 neither refreshes nor removes it. See docs/authoring-and-mirrors.md,
section 2.
-->
# Mermaid AI Skills
