---
description: "Narrative CV (CV-FRQ / CV des trois organismes)"
---
...
1. Resolve from `the file(s) or topic given after the command in the chat message (if none was given, use the file currently open in the editor)` (or ask, grouped, if missing): the competition
