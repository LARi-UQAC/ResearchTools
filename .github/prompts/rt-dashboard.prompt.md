---
description: "Start the rt-observe dashboard"
---
...
1. Parse `the file(s) or topic given after the command in the chat message (if none was given, use the file currently open in the editor)`. With no argument, run the dry run FIRST and show its output, because it
