---
description: "Accepted paper → conference talk"
---
...
1. Resolve the paper path from `the file(s) or topic given after the command in the chat message (if none was given, use the file currently open in the editor)` (a `.tex`, `.docx`, or `.pdf`, or the file open in the IDE).
